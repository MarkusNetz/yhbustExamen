...
<div class="w3-top">
	...
	<div class="w3-bar w3-blue-gray w3-hide-medium w3-hide-large w3-mobile w3-large">
		...
		?>
		<a href="/netzv/" class="w3-bar-item w3-button w3-col s3 w3-hover-none w3-border-none w3-hover-white w3-margin-8 w3-margin-right w3-round w3-white w3-small"><i class="fa fa-clipboard"></i> NetZV</a>
	</div>
</div>

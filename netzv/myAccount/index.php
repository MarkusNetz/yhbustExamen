	...
	<body class="w3-theme-l5" id="accountsPage">
		...
		<section class="w3-container w3-center w3-white" id="profilePresentation">
			<div class="w3-padding-16 w3-row">
				<h2><span class="w3-bottombar w3-border-teal"><?php echo ( isset($loggedInUser) ? $loggedInUser->getDisplayName() : (isset($ExternalUserProfile) ? $ExternalUserProfile->getDisplayName() : "" ) ); ?> - användarkonto</span></h2>
			</div>
